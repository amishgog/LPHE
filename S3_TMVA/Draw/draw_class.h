...
// Mon Jul 29 11:23:38 2024 by ROOT version 6.32.02
// from TTree DecayTree/DecayTree
// found on file: data_2011_MD_precut_add_BDT.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        Pmpi_M2;
   Double_t        PpPm_M2;
   Double_t        PVALLFit_DmPpPm_M;
   Double_t        PVALLFit_DmPmpi_M;
   Double_t        PVALLFit_DmPppi_M;
   Double_t        PVALLFit_PpPmpi_M;
   Double_t        PVALLFit_DmPp_M;
   Double_t        PVALLFit_DmPm_M;
   Double_t        PVALLFit_Dmpi_M;
   Double_t        PVALLFit_Pppi_M;
   Double_t        PVALLFit_Pmpi_M;
   Double_t        PVALLFit_PpPm_M;
   Double_t        PVALLFit_DmPpPm_M2;
   Double_t        PVALLFit_DmPmpi_M2;
   Double_t        PVALLFit_DmPppi_M2;
   Double_t        PVALLFit_PpPmpi_M2;
   Double_t        PVALLFit_DmPp_M2;
   Double_t        PVALLFit_DmPm_M2;
   Double_t        PVALLFit_Dmpi_M2;
   Double_t        PVALLFit_Pppi_M2;
   Double_t        PVALLFit_Pmpi_M2;
   Double_t        PVALLFit_PpPm_M2;
   Double_t        PVDFit_DmPpPm_M;
   Double_t        PVDFit_DmPmpi_M;
   Double_t        PVDFit_DmPppi_M;
   Double_t        PVDFit_DmPp_M;
   Double_t        PVDFit_DmPm_M;
   Double_t        PVDFit_Dmpi_M;
   Double_t        PVDFit_Pppi_M;
   Double_t        PVDFit_Pmpi_M;
   Double_t        PVDFit_PpPm_M;
   Double_t        PVDFit_DmPpPm_M2;
   Double_t        PVDFit_DmPmpi_M2;
   Double_t        PVDFit_DmPppi_M2;
   Double_t        PVDFit_DmPp_M2;
   Double_t        PVDFit_DmPm_M2;
   Double_t        PVDFit_Dmpi_M2;
   Double_t        PVDFit_Pppi_M2;
   Double_t        PVDFit_Pmpi_M2;
   Double_t        PVDFit_PpPm_M2;
   Double_t        PVFit_DmPpPm_M;
   Double_t        PVFit_DmPmpi_M;
   Double_t        PVFit_DmPppi_M;
   Double_t        PVFit_DmPp_M;
   Double_t        PVFit_DmPm_M;
   Double_t        PVFit_Dmpi_M;
   Double_t        PVFit_Pppi_M;
   Double_t        PVFit_Pmpi_M;
   Double_t        PVFit_PpPm_M;
   Double_t        PVFit_DmPpPm_M2;
   Double_t        PVFit_DmPmpi_M2;
   Double_t        PVFit_DmPppi_M2;
   Double_t        PVFit_DmPp_M2;
   Double_t        PVFit_DmPm_M2;
   Double_t        PVFit_Dmpi_M2;
   Double_t        PVFit_Pppi_M2;
   Double_t        PVFit_Pmpi_M2;
   Double_t        PVFit_PpPm_M2;
   Float_t         BDT;
   ...
   TBranch        *b_Pmpi_M2;   //!
   TBranch        *b_PpPm_M2;   //!
   TBranch        *b_PVALLFit_DmPpPm_M;   //!
   TBranch        *b_PVALLFit_DmPmpi_M;   //!
   TBranch        *b_PVALLFit_DmPppi_M;   //!
   TBranch        *b_PVALLFit_PpPmpi_M;   //!
   TBranch        *b_PVALLFit_DmPp_M;   //!
   TBranch        *b_PVALLFit_DmPm_M;   //!
   TBranch        *b_PVALLFit_Dmpi_M;   //!
   TBranch        *b_PVALLFit_Pppi_M;   //!
   TBranch        *b_PVALLFit_Pmpi_M;   //!
   TBranch        *b_PVALLFit_PpPm_M;   //!
   TBranch        *b_PVALLFit_DmPpPm_M2;   //!
   TBranch        *b_PVALLFit_DmPmpi_M2;   //!
   TBranch        *b_PVALLFit_DmPppi_M2;   //!
   TBranch        *b_PVALLFit_PpPmpi_M2;   //!
   TBranch        *b_PVALLFit_DmPp_M2;   //!
   TBranch        *b_PVALLFit_DmPm_M2;   //!
   TBranch        *b_PVALLFit_Dmpi_M2;   //!
   TBranch        *b_PVALLFit_Pppi_M2;   //!
   TBranch        *b_PVALLFit_Pmpi_M2;   //!
   TBranch        *b_PVALLFit_PpPm_M2;   //!
   TBranch        *b_PVDFit_DmPpPm_M;   //!
   TBranch        *b_PVDFit_DmPmpi_M;   //!
   TBranch        *b_PVDFit_DmPppi_M;   //!
   TBranch        *b_PVDFit_DmPp_M;   //!
   TBranch        *b_PVDFit_DmPm_M;   //!
   TBranch        *b_PVDFit_Dmpi_M;   //!
   TBranch        *b_PVDFit_Pppi_M;   //!
   TBranch        *b_PVDFit_Pmpi_M;   //!
   TBranch        *b_PVDFit_PpPm_M;   //!
   TBranch        *b_PVDFit_DmPpPm_M2;   //!
   TBranch        *b_PVDFit_DmPmpi_M2;   //!
   TBranch        *b_PVDFit_DmPppi_M2;   //!
   TBranch        *b_PVDFit_DmPp_M2;   //!
   TBranch        *b_PVDFit_DmPm_M2;   //!
   TBranch        *b_PVDFit_Dmpi_M2;   //!
   TBranch        *b_PVDFit_Pppi_M2;   //!
   TBranch        *b_PVDFit_Pmpi_M2;   //!
   TBranch        *b_PVDFit_PpPm_M2;   //!
   TBranch        *b_PVFit_DmPpPm_M;   //!
   TBranch        *b_PVFit_DmPmpi_M;   //!
   TBranch        *b_PVFit_DmPppi_M;   //!
   TBranch        *b_PVFit_DmPp_M;   //!
   TBranch        *b_PVFit_DmPm_M;   //!
   TBranch        *b_PVFit_Dmpi_M;   //!
   TBranch        *b_PVFit_Pppi_M;   //!
   TBranch        *b_PVFit_Pmpi_M;   //!
   TBranch        *b_PVFit_PpPm_M;   //!
   TBranch        *b_PVFit_DmPpPm_M2;   //!
   TBranch        *b_PVFit_DmPmpi_M2;   //!
   TBranch        *b_PVFit_DmPppi_M2;   //!
   TBranch        *b_PVFit_DmPp_M2;   //!
   TBranch        *b_PVFit_DmPm_M2;   //!
   TBranch        *b_PVFit_Dmpi_M2;   //!
   TBranch        *b_PVFit_Pppi_M2;   //!
   TBranch        *b_PVFit_Pmpi_M2;   //!
   TBranch        *b_PVFit_PpPm_M2;   //!
   TBranch        *b_BDT;   //!

   draw_class(TTree *tree=0);
   virtual ~draw_class();
...
#ifdef draw_class_cxx
draw_class::draw_class(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data_2011_MD_precut_add_BDT.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("data_2011_MD_precut_add_BDT.root");
      }
...
Int_t draw_class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t draw_class::LoadTree(Long64_t entry)
{
...
void draw_class::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("DmPpPm_M", &DmPpPm_M, &b_DmPpPm_M);
   fChain->SetBranchAddress("DmPmpi_M", &DmPmpi_M, &b_DmPmpi_M);
   fChain->SetBranchAddress("DmPppi_M", &DmPppi_M, &b_DmPppi_M);
   fChain->SetBranchAddress("DmPp_M", &DmPp_M, &b_DmPp_M);
   fChain->SetBranchAddress("DmPm_M", &DmPm_M, &b_DmPm_M);
   fChain->SetBranchAddress("Dmpi_M", &Dmpi_M, &b_Dmpi_M);
   fChain->SetBranchAddress("Pppi_M", &Pppi_M, &b_Pppi_M);
   fChain->SetBranchAddress("Pmpi_M", &Pmpi_M, &b_Pmpi_M);
   fChain->SetBranchAddress("PpPm_M", &PpPm_M, &b_PpPm_M);
   fChain->SetBranchAddress("DmPpPm_M2", &DmPpPm_M2, &b_DmPpPm_M2);
   fChain->SetBranchAddress("DmPmpi_M2", &DmPmpi_M2, &b_DmPmpi_M2);
   fChain->SetBranchAddress("DmPppi_M2", &DmPppi_M2, &b_DmPppi_M2);
   fChain->SetBranchAddress("DmPp_M2", &DmPp_M2, &b_DmPp_M2);
   fChain->SetBranchAddress("DmPm_M2", &DmPm_M2, &b_DmPm_M2);
   fChain->SetBranchAddress("Dmpi_M2", &Dmpi_M2, &b_Dmpi_M2);
   fChain->SetBranchAddress("Pppi_M2", &Pppi_M2, &b_Pppi_M2);
   fChain->SetBranchAddress("Pmpi_M2", &Pmpi_M2, &b_Pmpi_M2);
   fChain->SetBranchAddress("PpPm_M2", &PpPm_M2, &b_PpPm_M2);
   fChain->SetBranchAddress("PVALLFit_DmPpPm_M", &PVALLFit_DmPpPm_M, &b_PVALLFit_DmPpPm_M);
   fChain->SetBranchAddress("PVALLFit_DmPmpi_M", &PVALLFit_DmPmpi_M, &b_PVALLFit_DmPmpi_M);
   fChain->SetBranchAddress("PVALLFit_DmPppi_M", &PVALLFit_DmPppi_M, &b_PVALLFit_DmPppi_M);
   fChain->SetBranchAddress("PVALLFit_PpPmpi_M", &PVALLFit_PpPmpi_M, &b_PVALLFit_PpPmpi_M);
   fChain->SetBranchAddress("PVALLFit_DmPp_M", &PVALLFit_DmPp_M, &b_PVALLFit_DmPp_M);
   fChain->SetBranchAddress("PVALLFit_DmPm_M", &PVALLFit_DmPm_M, &b_PVALLFit_DmPm_M);
   fChain->SetBranchAddress("PVALLFit_Dmpi_M", &PVALLFit_Dmpi_M, &b_PVALLFit_Dmpi_M);
   fChain->SetBranchAddress("PVALLFit_Pppi_M", &PVALLFit_Pppi_M, &b_PVALLFit_Pppi_M);
   fChain->SetBranchAddress("PVALLFit_Pmpi_M", &PVALLFit_Pmpi_M, &b_PVALLFit_Pmpi_M);
   fChain->SetBranchAddress("PVALLFit_PpPm_M", &PVALLFit_PpPm_M, &b_PVALLFit_PpPm_M);
   fChain->SetBranchAddress("PVALLFit_DmPpPm_M2", &PVALLFit_DmPpPm_M2, &b_PVALLFit_DmPpPm_M2);
   fChain->SetBranchAddress("PVALLFit_DmPmpi_M2", &PVALLFit_DmPmpi_M2, &b_PVALLFit_DmPmpi_M2);
   fChain->SetBranchAddress("PVALLFit_DmPppi_M2", &PVALLFit_DmPppi_M2, &b_PVALLFit_DmPppi_M2);
   fChain->SetBranchAddress("PVALLFit_PpPmpi_M2", &PVALLFit_PpPmpi_M2, &b_PVALLFit_PpPmpi_M2);
   fChain->SetBranchAddress("PVALLFit_DmPp_M2", &PVALLFit_DmPp_M2, &b_PVALLFit_DmPp_M2);
   fChain->SetBranchAddress("PVALLFit_DmPm_M2", &PVALLFit_DmPm_M2, &b_PVALLFit_DmPm_M2);
   fChain->SetBranchAddress("PVALLFit_Dmpi_M2", &PVALLFit_Dmpi_M2, &b_PVALLFit_Dmpi_M2);
   fChain->SetBranchAddress("PVALLFit_Pppi_M2", &PVALLFit_Pppi_M2, &b_PVALLFit_Pppi_M2);
   fChain->SetBranchAddress("PVALLFit_Pmpi_M2", &PVALLFit_Pmpi_M2, &b_PVALLFit_Pmpi_M2);
   fChain->SetBranchAddress("PVALLFit_PpPm_M2", &PVALLFit_PpPm_M2, &b_PVALLFit_PpPm_M2);
   fChain->SetBranchAddress("PVDFit_DmPpPm_M", &PVDFit_DmPpPm_M, &b_PVDFit_DmPpPm_M);
   fChain->SetBranchAddress("PVDFit_DmPmpi_M", &PVDFit_DmPmpi_M, &b_PVDFit_DmPmpi_M);
   fChain->SetBranchAddress("PVDFit_DmPppi_M", &PVDFit_DmPppi_M, &b_PVDFit_DmPppi_M);
   fChain->SetBranchAddress("PVDFit_DmPp_M", &PVDFit_DmPp_M, &b_PVDFit_DmPp_M);
   fChain->SetBranchAddress("PVDFit_DmPm_M", &PVDFit_DmPm_M, &b_PVDFit_DmPm_M);
   fChain->SetBranchAddress("PVDFit_Dmpi_M", &PVDFit_Dmpi_M, &b_PVDFit_Dmpi_M);
   fChain->SetBranchAddress("PVDFit_Pppi_M", &PVDFit_Pppi_M, &b_PVDFit_Pppi_M);
   fChain->SetBranchAddress("PVDFit_Pmpi_M", &PVDFit_Pmpi_M, &b_PVDFit_Pmpi_M);
   fChain->SetBranchAddress("PVDFit_PpPm_M", &PVDFit_PpPm_M, &b_PVDFit_PpPm_M);
   fChain->SetBranchAddress("PVDFit_DmPpPm_M2", &PVDFit_DmPpPm_M2, &b_PVDFit_DmPpPm_M2);
   fChain->SetBranchAddress("PVDFit_DmPmpi_M2", &PVDFit_DmPmpi_M2, &b_PVDFit_DmPmpi_M2);
   fChain->SetBranchAddress("PVDFit_DmPppi_M2", &PVDFit_DmPppi_M2, &b_PVDFit_DmPppi_M2);
   fChain->SetBranchAddress("PVDFit_DmPp_M2", &PVDFit_DmPp_M2, &b_PVDFit_DmPp_M2);
   fChain->SetBranchAddress("PVDFit_DmPm_M2", &PVDFit_DmPm_M2, &b_PVDFit_DmPm_M2);
   fChain->SetBranchAddress("PVDFit_Dmpi_M2", &PVDFit_Dmpi_M2, &b_PVDFit_Dmpi_M2);
   fChain->SetBranchAddress("PVDFit_Pppi_M2", &PVDFit_Pppi_M2, &b_PVDFit_Pppi_M2);
   fChain->SetBranchAddress("PVDFit_Pmpi_M2", &PVDFit_Pmpi_M2, &b_PVDFit_Pmpi_M2);
   fChain->SetBranchAddress("PVDFit_PpPm_M2", &PVDFit_PpPm_M2, &b_PVDFit_PpPm_M2);
   fChain->SetBranchAddress("PVFit_DmPpPm_M", &PVFit_DmPpPm_M, &b_PVFit_DmPpPm_M);
   fChain->SetBranchAddress("PVFit_DmPmpi_M", &PVFit_DmPmpi_M, &b_PVFit_DmPmpi_M);
   fChain->SetBranchAddress("PVFit_DmPppi_M", &PVFit_DmPppi_M, &b_PVFit_DmPppi_M);
   fChain->SetBranchAddress("PVFit_DmPp_M", &PVFit_DmPp_M, &b_PVFit_DmPp_M);
   fChain->SetBranchAddress("PVFit_DmPm_M", &PVFit_DmPm_M, &b_PVFit_DmPm_M);
   fChain->SetBranchAddress("PVFit_Dmpi_M", &PVFit_Dmpi_M, &b_PVFit_Dmpi_M);
   fChain->SetBranchAddress("PVFit_Pppi_M", &PVFit_Pppi_M, &b_PVFit_Pppi_M);
   fChain->SetBranchAddress("PVFit_Pmpi_M", &PVFit_Pmpi_M, &b_PVFit_Pmpi_M);
   fChain->SetBranchAddress("PVFit_PpPm_M", &PVFit_PpPm_M, &b_PVFit_PpPm_M);
   fChain->SetBranchAddress("PVFit_DmPpPm_M2", &PVFit_DmPpPm_M2, &b_PVFit_DmPpPm_M2);
   fChain->SetBranchAddress("PVFit_DmPmpi_M2", &PVFit_DmPmpi_M2, &b_PVFit_DmPmpi_M2);
   fChain->SetBranchAddress("PVFit_DmPppi_M2", &PVFit_DmPppi_M2, &b_PVFit_DmPppi_M2);
   fChain->SetBranchAddress("PVFit_DmPp_M2", &PVFit_DmPp_M2, &b_PVFit_DmPp_M2);
   fChain->SetBranchAddress("PVFit_DmPm_M2", &PVFit_DmPm_M2, &b_PVFit_DmPm_M2);
   fChain->SetBranchAddress("PVFit_Dmpi_M2", &PVFit_Dmpi_M2, &b_PVFit_Dmpi_M2);
   fChain->SetBranchAddress("PVFit_Pppi_M2", &PVFit_Pppi_M2, &b_PVFit_Pppi_M2);
   fChain->SetBranchAddress("PVFit_Pmpi_M2", &PVFit_Pmpi_M2, &b_PVFit_Pmpi_M2);
   fChain->SetBranchAddress("PVFit_PpPm_M2", &PVFit_PpPm_M2, &b_PVFit_PpPm_M2);
   fChain->SetBranchAddress("BDT", &BDT, &b_BDT);
   Notify();
}

bool draw_class::Notify()
{
...
void draw_class::Show(Long64_t entry)
{
...
Int_t draw_class::Cut(Long64_t entry)
{
