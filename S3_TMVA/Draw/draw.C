...
void draw()
{
    ...
    TChain *tr_dt = new TChain("DecayTree"); tr_dt->Add("../root/data_201*BDT.root");
    TChain *tr_mc = new TChain("DecayTree"); tr_mc->Add("../root/mc_*BDT.root");
    TChain *tr_sb = new TChain("DecayTree"); tr_sb->Add("../root/data_201*BDT.root");
    ...
    vare.push_back("PVALLFit_DmPm_M");  Xbins.push_back(100); Xmin.push_back(2700); Xmax.push_back(4100); Xtitle.push_back("M(D^{-}#bar{p}) MeV/c^{2}");  Savename.push_back("PVALLFit_DmPm_M");
    ...
    vare.push_back("PVALLFit_DmPppi_M");  Xbins.push_back(150); Xmin.push_back(3000); Xmax.push_back(4400); Xtitle.push_back("M(D^{-}p#pi^{+}) MeV/c^{2}");  Savename.push_back("PVALLFit_DmPppi_M");
    vare.push_back("PVALLFit_DmPmpi_M");  Xbins.push_back(150); Xmin.push_back(3000); Xmax.push_back(4400); Xtitle.push_back("M(D^{-}#bar{p}#pi^{+}) MeV/c^{2}");  Savename.push_back("PVALLFit_DmPmpi_M");
    vare.push_back("PVALLFit_DmPpPm_M");  Xbins.push_back(100); Xmin.push_back(3800); Xmax.push_back(5200); Xtitle.push_back("M(D^{-}p#bar{p}) MeV/c^{2}");  Savename.push_back("PVALLFit_DmPpPm_M");
    ...
    for(int i=0; i<vare.size(); i++){
        ...
        TCut bdt = "BDT > -0.14";
        TCut cut_b_mass;
        cut_b_mass = "B0_PVDFit_M>5245.32 && B0_PVDFit_M<5314.78";
        TCut cut_b_side;
        cut_b_side = "B0_PVDFit_M>5350 && B0_PVDFit_M<5600";

        TCut cut_d_mass;
        cut_d_mass = "B0_PVFit_Dplus_M>1840 && B0_PVFit_Dplus_M<1890";
        TCut cut_d_side;
        ...
        th1f_data_sb[i]->Scale(0.8192125876);
	...
	//     xmax = std::max({xmax, th1f_data[i]->GetXaxis()->GetXmax(), th1f_data_sb[i]->GetXaxis()->GetXmax(), th1f_part[i]->GetXaxis()->GetXmax()});
        ...
        // th1f_mc[i]->SetLineWidth(2); th1f_mc[i]->SetLineColor(kRed);
        ...
        TString sv1_png_mc = "./mc_plots/";
        sv1_png = "./plots/";
        //v1_png = "./plots/D2HH_" + KS + "/Plot1D_" + Year + "_" + KS + "_";
        TString sv2_png_mc = ".png";
        TString sv2_png = ".png";
        TString can_path1_mc = sv1_png_mc + savename + sv2_png_mc;
