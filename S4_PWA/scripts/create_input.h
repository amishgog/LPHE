...
// Mon Jul  1 17:12:18 2024 by ROOT version 6.32.00
...
#ifdef create_input_cxx
create_input::create_input(TTree *tree) : fChain(0) 
{
...
Int_t create_input::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t create_input::LoadTree(Long64_t entry)
{
...
void create_input::Init(TTree *tree)
{
...
void create_input::Show(Long64_t entry)
{
...
Int_t create_input::Cut(Long64_t entry)
{
