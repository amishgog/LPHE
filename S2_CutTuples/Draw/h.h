...
// Thu Jun 13 14:15:43 2024 by ROOT version 6.30/04
// from TTree DecayTree/DecayTree
// found on file: data_2011_MD_precut_add.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data_2011_MD_precut_add.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("data_2011_MD_precut_add.root");
      }
