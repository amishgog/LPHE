...
// Tue Jun 18 16:39:43 2024 by ROOT version 6.30/04
// from TTree DecayTree/DecayTree
// found on file: mc_2018_MD_Clean.root
//////////////////////////////////////////////////////////

#ifndef make_checked_mc_h
#define make_checked_mc_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   make_checked_mc(TTree *tree=0);
   virtual ~make_checked_mc();
...
#ifdef make_checked_mc_cxx
make_checked_mc::make_checked_mc(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("mc_2018_MD_Clean.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("mc_2018_MD_Clean.root");
      }
...
make_checked_mc::~make_checked_mc()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t make_checked_mc::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t make_checked_mc::LoadTree(Long64_t entry)
{
...
void make_checked_mc::Init(TTree *tree)
{
...
void make_checked_mc::Show(Long64_t entry)
{
...
Int_t make_checked_mc::Cut(Long64_t entry)
{
...
#endif // #ifdef make_checked_mc_cxx
